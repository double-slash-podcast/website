  ...
  >
    ...
    >
      ...
      <span class="flex items-center gap-4">
        <a
          href="https://github.com/double-slash-podcast/website"
          target="_blank"
          rel="noopener noreferrer"
          class="inline-flex items-center gap-1 underline"
        >
          <Icon name="mdi:github" mode="css" size="16" /> Code source du site </a
        ><a href="/llms.txt" class="inline-flex underline">llms.txt</a>
      </span>
    </div>
  </footer>
</template>
