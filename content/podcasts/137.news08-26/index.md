...
### ~~Grok Bot : Des agents IA pour automatiser vos tâches~~

~~https://x.ai/bot~~

~~Grok Bot est une nouvelle génération d'agents IA conçus pour travailler comme des collègues. Ils peuvent se connecter à vos outils, suivre des workflows, apprendre de vos habitudes et collaborer entre eux pour accomplir des tâches complexes. Disponible sur macOS et iOS, Grok Bot permet de déléguer des projets entiers, de la recherche à la génération de pipelines, en passant par la gestion de tâches répétitives. Une solution idéale pour automatiser des processus métiers tout en gardant le contrôle.~~
